...
def main():
    ...
    parser.add_argument('--br0',    required=True,
                        help='Path to best-response advantage network for P0')
    parser.add_argument('--br1',    required=True,
    ...
    print(f"  TiltStack edge as SB     : {sb_payoff / args.pairs * CHIPS_TO_MBB:+.2f} mBB/hand")
    print(f"  TiltStack edge as BB     : {bb_payoff / args.pairs * CHIPS_TO_MBB:+.2f} mBB/hand")
